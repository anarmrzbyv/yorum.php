...
if (($_SERVER['REQUEST_METHOD'] == "POST")){
    ...
    $moviescontroller->editMovie($_POST['id']);
}
...
<!--    generden filim kateqorisi secir-->
                            ...
                            <div id="add-movie-form-container">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="title" placeholder=""
                                               name="mv_title" value="<?php echo $movie[0]['mv_title'] ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        $current_genres = $crud->read("select * from mv_genres join genres on gnr_id = mvg_ref_genre where mvg_ref_movie= $movie_id");
                                        ...
                                        <select data-placeholder="Select Genre(s)..." multiple class="form-control genre" name="genres[]" id="genre[]">
                                            ...
                                            <?php foreach ($current_genres as $key => $genre) {?>
                                                <option value="<?php echo $genre['gnr_id'] ?>" selected="selected"><?php echo $genre['gnr_name'] ?></option>
                                            <?php } ?>
                                        </select>
                                        <span class="help-block"></span>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input id="datepicker" name="mv_year_released" data-date-format="yyyy-mm-dd"
                                               class="form-control" type="text" value="<?= $movie[0]['mv_year_released']?>">
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-sm-2" for="year">Cover Image:</label>
                                    <img src="../<?= $movie[0]['img_path']?>" width="194" height="259" style="margin-bottom: 15px" alt="">
                                    <div class="col-sm-10">
